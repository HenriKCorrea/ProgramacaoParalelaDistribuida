...
int main()
{
    // registerrpc - Registra na biblioteca RPC a função que estará disponível on-line
/*
//  NOTASPROG - Identificador do programa. Deve ser unico.
//  NOTASVERS - Define a versão do programa. Pode ter várias versões para o mesmo identificador de programa.
//  OBTEM_NOTA - Código identificador da função.
//  obtem_nota_1_svc - Nome da função a ser chamada.
//
//  (xdrproc_t)xdr_wrapstring - Argumento que a função recebe conforme 
*/
